...
// Behaviour for Goblin (Very simpleton); attacks player if in range, move closer to attack or end turn
[CreateAssetMenu(fileName = "GoblinBehaviour", menuName = "CombatData/AIBehaviour/Goblin")]
public class GoblinBehaviour : EnemyAIBehaviour
{
    public override void SelectAction(EnemyCombat enemy)
    {
        ...
        if (enemy.currentAP >= 5)
        {
            ...
            else
            {
                ...
                Debug.Log($"ME CAN HITTI PLAYER FROM {moveToTile}");
